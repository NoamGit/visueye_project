%% script - data parsing with the baysian inference approach from fluoerecence 
...
cellCenters = cell2mat(cellfun(@(x) getCoord(x(5:end)) ,cellNames)); % [x ; y]
...
date_idx = [false; strcmp('ANALYSIS', pathTokens{1})];
